                ...
                <table>
                    <tbody>
                        <tr>
                            <td>
                                New Review &nbsp;
                                <svg onClick = {() => this.props.toggleNewReview()} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
